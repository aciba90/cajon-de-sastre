...
existing association unchanged, as a change would imply a migration of the DB because we
store the anagram hashes in our db. We can extend our alphabet infinitely because there
